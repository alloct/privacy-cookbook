...
- Accidentally committed secrets or personal data in the repository or its
  history.
- Dangerous errors in security-relevant content — advice that, if
...
- The absence of HTTP headers GitHub Pages does not support — documented
  deliberately in [docs/internal/security.md](docs/internal/security.md)
  and on the site's [privacy page](src/about/site-privacy.md).
...
accounts or sessions — reports premised on stealing user data from the
site will generally be out of scope for that reason.
