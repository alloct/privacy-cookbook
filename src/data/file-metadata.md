...
where the audience shouldn't learn where you live or who wrote a document (listings, forums, leaks, activism, anything posted pseudonymously) stripping metadata is mandatory, and it must happen **before** the file
leaves your machine.
