...
- **iPhone/iPad and modern Android:** encrypted by default, keys protected
  by dedicated hardware. Your passcode strength is the effective security, see the caveat below.
- **Windows:** BitLocker on Pro/Enterprise editions; Windows Home offers
  ...
  setups may escrow the recovery key to your Microsoft account, convenient, and a custody decision you should make deliberately.
...
first-unlock) devices**. It does not protect a running, unlocked machine, malware and rubber-hose access read encrypted disks exactly as well as you
